...
public class TestPeriod_Basics extends TestCase {
    ...
    // long added = test.addTo(TEST_TIME_NOW, -2, ISOChronology.getInstanceUTC());
    // // local specified so use it
    // assertEquals(expected, added);
    // }
    //
    ...
    //
    // Period test = new Period(1, 2, 3, 4, 5, 6, 7, 8, PeriodType.standard());
    // long added = test.addTo(TEST_TIME_NOW, -2, null); // no chrono specified so
    // use default
    // assertEquals(expected, added);
    // }
    //
    ...
    //
    // Period test = new Period(1, 2, 3, 4, 5, 6, 7, 8);
    // DateTime added = test.addTo(new Instant(), 1); // Instant has no time zone,
    // use default
    ...
    //
    // Period test = new Period(1, 2, 3, 4, 5, 6, 7, 8, PeriodType.standard());
    // DateTime added = test.addTo(new Instant(), -2); // Instant has no time zone,
    // use default
    // assertEquals(expected, added.getMillis());
    // assertEquals(ISOChronology.getInstance(), added.getChronology());
    // }
    ...
    //
    // Period test = new Period(1, 2, 3, 4, 5, 6, 7, 8, PeriodType.standard());
    // DateTime added = test.addTo(new DateTime(ISOChronology.getInstanceUTC()),
    // -2); // DateTime has UTC time zone
    // assertEquals(expected, added.getMillis());
    ...
    //
    // Period test = new Period(1, 2, 3, 4, 5, 6, 7, 8, PeriodType.standard());
    // DateTime added = test.addTo(new DateTime(PARIS), -2); // DateTime has PARIS
    // time zone
    // assertEquals(expected, added.getMillis());
    ...
    public void testToString_PeriodFormatter() {
        Period test = new Period(1, 2, 3, 4, 5, 6, 7, 8);
        assertEquals("1 year, 2 months, 3 weeks, 4 days, 5 hours, 6 minutes, 7 seconds and 8 milliseconds",
                test.toString(PeriodFormat.getDefault()));
    ...
    public void testToStandardWeeks() {
        ...
        test = new Period(0, 0, 0, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE,
                Integer.MAX_VALUE);
    ...
    public void testToStandardDuration() {
        ...
        // test = new Period(0, 0, Integer.MAX_VALUE, Integer.MAX_VALUE,
