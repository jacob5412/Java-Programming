...
public class TempTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.format("local=%s .instant=%d\n", local.toString(), local.toDate().getTime()); // output:
                                                                                                 // local=2014-01-31
                                                                                                 // .instant=1391155200000
        LocalDate utc = new LocalDate(cUTC.getTimeInMillis(), DateTimeZone.UTC);
        System.out.println(utc + " " + utc.getLocalMillis());
        System.out.format("utc=%s .instant=%d\n", utc.toString(), utc.toDate().getTime());// output: utc=2014-02-01
                                                                                          // .instant=1391241600000

        Period p1 = Period.fieldDifference(utc, local);
        Period p = p1.normalizedStandard(PeriodType.millis()); // java.lang.ArithmeticException: Value cannot fit in an
                                                               // int: 2592000000
        ...
        DateTime dtUTC = new DateTime(2014, 2, 1, 0, 0, DateTimeZone.UTC); // Assume UTC = server+8 hours (actual code
                                                                           // uses DateTime.now(DateTimeZone.UTC))
        ...
        //
        // Period p =
        // Period.fieldDifference(utc,local).normalizedStandard(PeriodType.millis());
        // //Throws a java.lang.ArithmeticException: Value cannot fit in an int: xx
        // System.out.println(p);

        // DateTime dtLocal = new DateTime(2014, 1, 31, 15, 59); //Server time
        // DateTime dtUTC = new DateTime(2014, 1, 31, 12, 59, DateTimeZone.UTC);
        // //Assume UTC = server+8 hours (actual code uses
        ...
        // // i.e. joda thinks that 2012-11-04T00:59:59.998-04:00 is an instance of
        // 2012-11-3
        ...
        // DateTimeFormat.forPattern("dd/MM/yyyy").withZoneUTC();
        // DateTime dateTime = DateTime.parse("10/06/2014",
        ...
        //
        // LocalDate ethiopic = new LocalDate(1, 1, 1,
        ...
        // DateTimeFormatter df = DateTimeFormat.forPattern("EEE, dd MMM yyyy HH:mm:ss
        // zzz");
        //
        ...
        // System.out.println(DateTimeComparator.getDateOnlyInstance().compare(date1,
        // date2));
        // System.out.println(DateTimeComparator.getDateOnlyInstance().compare(date1,
        // date1.plusMinutes(1)));
        ...
        // MutableDateTime result = new MutableDateTime(2000, 1, 1, 0, 0, 0, 0,
        // NEWYORK);
        // System.out.println("4 = " + f.parseInto(result, "2 29", 0));
        // System.out.println("" + new MutableDateTime(2000, 2, 29, 0, 0, 0, 0, NEWYORK)
        // + " = " + result);
        ...
        // System.out.println("time_millis: " + time.getMillis() + ", utc_millis " +
        // utcTime.getMillis());
        //
        //// MutableDateTime time = new MutableDateTime(DateTimeZone.forOffsetHours(1));
        ////// time.setZone(DateTimeZone.forOffsetHours(1));
