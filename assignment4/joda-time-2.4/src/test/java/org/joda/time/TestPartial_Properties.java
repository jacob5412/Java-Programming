...
public class TestPartial_Properties extends TestCase {
    ...
    public void testPropertyGetMinute() {
        ...
        assertEquals(test.getChronology().minutes(),
                test.property(DateTimeFieldType.minuteOfHour()).getDurationField());
        assertEquals(test.getChronology().hours(),
                test.property(DateTimeFieldType.minuteOfHour()).getRangeDurationField());
    ...
    //
    // copy = test.property(DateTimeFieldType.minuteOfHour()).addToCopy(1 * 60 +
    // 45);
    // check(copy, 12, 5, 30, 40);
    //
    // copy = test.property(DateTimeFieldType.minuteOfHour()).addToCopy(13 * 60 +
    // 39);
    ...
    //
    // copy = test.property(DateTimeFieldType.minuteOfHour()).addToCopy(-(10 * 60 +
    // 20));
    // check(copy, 0, 0, 30, 40);
    //
    // copy = test.property(DateTimeFieldType.minuteOfHour()).addToCopy(-(10 * 60 +
