...
public class TestSerialization extends TestCase {
    ...
    // private static class MockDelegatedDurationField extends
    // DelegatedDurationField implements Serializable {
    ...
    // }
    //
    // // Format changed in v1.2 - min days in first week not deserialized in
    // v1.0/1.1
    // public void testStoreSerializedGJChronologyChangedInternals() throws
    // Exception {
    // GJChronology test = GJChronology.getInstance(PARIS, 123L, 2);
    ...
    // MillisDurationField test = (MillisDurationField)
