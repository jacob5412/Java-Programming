...
public class MutablePeriod
     ...
     * <p>
     * When dividing the duration, only precise fields in the period type will be
     * used.
     ...
     * @throws ArithmeticException      if the addition exceeds the capacity of the
     *                                  period
     */
     ...
     * 
     * @param years   amount of years to add to this period, which must be zero if
     *                unsupported
     * @param months  amount of months to add to this period, which must be zero if
     *                unsupported
     * @param weeks   amount of weeks to add to this period, which must be zero if
     *                unsupported
     * @param days    amount of days to add to this period, which must be zero if
     *                unsupported
     * @param hours   amount of hours to add to this period, which must be zero if
     *                unsupported
     * @param minutes amount of minutes to add to this period, which must be zero if
     *                unsupported
     * @param seconds amount of seconds to add to this period, which must be zero if
     *                unsupported
     * @param millis  amount of milliseconds to add to this period, which must be
     *                zero if unsupported
     * @throws IllegalArgumentException if the period being added contains a field
     *                                  not supported by this period
     * @throws ArithmeticException      if the addition exceeds the capacity of the
     ...
     * @throws IllegalArgumentException if field is not supported and the value is
     *                                  non-zero
     */
