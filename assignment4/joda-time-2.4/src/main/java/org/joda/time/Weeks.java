...
public final class Weeks extends BaseSingleFieldPeriod {
    ...
    /**
     * Constant representing the maximum number of weeks that can be stored in this
     * object.
     */
    public static final Weeks MAX_VALUE = new Weeks(Integer.MAX_VALUE);
    /**
     * Constant representing the minimum number of weeks that can be stored in this
     * object.
     */
    ...
    /**
     * Creates a new <code>Weeks</code> by parsing a string in the ISO8601 format
     * 'PnW'.
     * <p>
     * The parse will accept the full ISO syntax of PnYnMnWnDTnHnMnS however only
     * the
     * weeks component may be non-zero. If any other component is non-zero, an
     * exception
     * will be thrown.
     *
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param weeks the amount of weeks to take away, may be negative, null means
     *              zero
     * @return the new period minus the specified number of weeks
     * @throws ArithmeticException if the result overflows an int
     */
