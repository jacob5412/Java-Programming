...
public final class DateTime
     ...
     * The object produced via this method has a zone of
     * {@code DateTimeZone.forOffsetHours(1)}.
     * The object produced via the constructor has a zone of
     * {@code DateTimeZone.getDefault()}.
     * 
     ...
     *
     * @return a copy of this datetime with the earliest valid offset for the local
     *         datetime
     */
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @return a copy of this datetime with the latest valid offset for the local
     *         datetime
     */
    ...
    // -----------------------------------------------------------------------
    /**
     * Returns a copy of this datetime with the specified date, retaining the time
     * fields.
     * <p>
    ...
    /**
     * Returns a copy of this datetime with the specified time, retaining the date
     * fields.
     * <p>
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        public DateTime withMinimumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(ex)) {
                    // subtracting MILLIS_PER_DAY is not perfect, but will work in almost all
                    // situations
