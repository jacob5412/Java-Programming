...
public final class LocalDate
     ...
     * If adding years makes the day-of-month invalid, it is adjusted to the last
     ...
     * If adding months makes the day-of-month invalid, it is adjusted to the last
     * valid day in the month.
     * This LocalDate instance is immutable and unaffected by this method call.
     * <p>
     * The following three lines are identical in effect:
     ...
     * If subtracting years makes the day-of-month invalid, it is adjusted to the
     * last valid day in the month.
     * This LocalDate instance is immutable and unaffected by this method call.
     * <p>
     * The following three lines are identical in effect:
     * 
     ...
     * The subtraction may change the year, but the day-of-month is normally
     * unchanged.
     * If subtracting months makes the day-of-month invalid, it is adjusted to the
     * last valid day in the month.
     * This LocalDate instance is immutable and unaffected by this method call.
     * <p>
     * The following three lines are identical in effect:
