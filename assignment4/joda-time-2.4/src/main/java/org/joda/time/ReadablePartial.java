 ...
 * thus a local time.
 * <p>
 * A {@code ReadablePartial} supports a subset of those fields on the
 * chronology.
 * It cannot be compared to a {@code ReadableInstant}, as it does not fully
 * specify an instant in time. The time it does specify is a local time, and
 * does
 ...
 * The comparison is based on the fields, compared in order, from largest to
 * smallest.
...
public interface ReadablePartial extends Comparable<ReadablePartial> {
     ...
     *
     * @param baseInstant the instant that provides the missing fields, null means
     *                    now
