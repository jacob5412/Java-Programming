...
public final class Hours extends BaseSingleFieldPeriod {
    ...
    /**
     * Constant representing the maximum number of hours that can be stored in this
     * object.
     */
    public static final Hours MAX_VALUE = new Hours(Integer.MAX_VALUE);
    /**
     * Constant representing the minimum number of hours that can be stored in this
     * object.
     */
    ...
    /**
     * Creates a new <code>Hours</code> by parsing a string in the ISO8601 format
     * 'PTnH'.
     * <p>
     * The parse will accept the full ISO syntax of PnYnMnWnDTnHnMnS however only
     * the
     * hours component may be non-zero. If any other component is non-zero, an
     * exception
     * will be thrown.
     *
     ...
     * <p>
     * This method allows you to convert between different types of period.
     * However to achieve this it makes the assumption that all hours are 60 minutes
     * long.
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param hours the amount of hours to take away, may be negative, null means
     *              zero
     * @return the new period minus the specified number of hours
     * @throws ArithmeticException if the result overflows an int
     */
