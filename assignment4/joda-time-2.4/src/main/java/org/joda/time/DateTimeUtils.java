 ...
 * for thread-safety. These can be changed during the lifetime of the
 * application
...
public class DateTimeUtils {
     ...
     * Whenever the current time is queried, {@link System#currentTimeMillis()} is
     * used.
     * 
     * @throws SecurityException if the application does not have sufficient
     *                           security rights
     */
     ...
     * <p>
     * This method changes the behaviour of {@link #currentTimeMillis()}.
     * Whenever the current time is queried, the same millisecond time will be
     * returned.
     * 
    ...
    /**
     * Checks whether the provider may be changed using permission
     * 'CurrentTime.setProvider'.
     * 
     ...
     * 
     * @param start the instant to examine and use as the primary source of the
     *              chronology
     * @param end   the instant to examine and use as the secondary source of the
     *              chronology
     * @return the chronology, never null
     */
    ...
    // -----------------------------------------------------------------------
    /**
     * Gets the millisecond duration from the specified duration object handling
     * null.
     * <p>
     ...
     * 
     * @param locale the {@link Locale} used to get the correct
     ...
     * <p>
     * The <a href="http://en.wikipedia.org/wiki/Julian_day">Julian day</a> is a
     * well-known
     ...
     * Thus the fraction 0.25 is 18:00. equal to one quarter of the day from midday
     * to midday.
     * <p>
    ...
    public static final double toJulianDay(long epochMillis) {
        ...
        // Julian Date Converter by Matt Oltersdorf
