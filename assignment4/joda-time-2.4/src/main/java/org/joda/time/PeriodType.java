...
/**
 * Controls a period implementation by specifying which duration fields are to
 * be used.
 * <p>
...
public class PeriodType implements Serializable {
     ...
     * 
     * @return a new period type that supports the original set of fields except
     *         years
     */
    ...
    /**
     * Returns a version of this PeriodType instance that does not support
     * milliseconds.
     * 
     * @return a new period type that supports the original set of fields except
     *         milliseconds
