...
public class CharsetTest extends BaseTestCase {
     ...
     * JISX0208.
     */
    public static final char[] SJIS_CHARS = new char[] { 0xFF71, // halfwidth katakana letter A, 0xB100 of SJIS, one of
                                                                 // JISX0201.
     ...
     */
    private static final char[] CP932_CHARS = new char[] { 0xFF71, // halfwidth katakana letter A, 0xB100 of
                                                                   // WINDOWS-31J, one of JISX0201.
     ...
     * JISX0212.
     */
    public static final char[] UJIS_CHARS = new char[] { 0xFF71, // halfwidth katakana letter A, 0x8EB1 of ujis, one of
                                                                 // JISX0201.
     ...
     */
    public static final char[] EUCJPMS_CHARS = new char[] { 0xFF71, // halfwidth katakana letter A, 0x8EB1 of ujis, one
                                                                    // of JISX0201.
            0x65E5, // CJK unified ideograph, 0xC6FC of ujis, one of JISX0208.
            0x7B5D, // CJK unified ideograph, 0xE4B882 of ujis, one of JISX0212
    ...
    public void testStaticCharsetMappingConsistency() {
        for (int i = 1; i < CharsetMapping.MAP_SIZE; i++) {
            ...
            assertNotNull("Assertion failure: No mapping from charset index " + i + " to a Java character set",
                    CharsetMapping.COLLATION_INDEX_TO_CHARSET[i]);
        }
    }
    ...
    public void testCharsetMapping() throws Exception {
        ...
        while (i1.hasNext()) {
            ...
            System.out.println((canonicalName + "                              ").substring(0, 26) + " ("
                    + cs.canEncode() + ") --> "
            ...
            while (j.hasNext()) {
                ...
                System.out.println("   " + (alias + "                              ").substring(0, 30) + " --> "
                        ...
                        + CharsetMapping.getCollationIndexForJavaEncoding(alias, this.serverVersion) + "  :  "
        ...
        for (int i = 1; i < CharsetMapping.MAP_SIZE; i++) {
            ...
            System.out.println((i + "   ").substring(0, 4) + " by index--> "
                    ...
                    + "  :  "
                    + (CharsetMapping.getMysqlCharsetForJavaEncoding(enc, this.serverVersion) + "               ")
                            .substring(0, 15));
        }
    }
    ...
    public void testGB18030() throws Exception {
        ...
        String[][] str = new String[][] {
                ...
                { "8239AB318239AB358239AF3583308132833087348335EB39", "\uB46C\uB470\uB498\uB7B5\uB7F3\uD47C" },
                ...
                { "4A7320204B82339A35646566", "Js  K\u4478def" }, { "8130883281308833", "\u00CE\u00CF" },
                { "E05FE06A777682339230", "\u90F7\u9107wv\u4423" },
                { "814081418139FE30", "\u4E02\u4E04\u3499" }, { "81308130FEFE", "\u0080\uE4C5" },
                { "E3329A35E3329A34", "\uDBFF\uDFFF\uDBFF\uDFFE" } };
        ...
        while (rset.next()) {
            ...
            assertTrue("HEX value " + hex + " for char " + rset.getString(1) + " is unexpected",
