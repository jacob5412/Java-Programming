...
public enum MysqlType implements SQLType {
     ...
     * precision) and D is the number of digits
     * after the decimal point (the scale). The decimal point and (for negative
     * numbers) the "-" sign are not counted in M.
     * If D is 0, values have no decimal point or fractional part. The maximum
     * number of digits (M) for DECIMAL is 65.
     ...
     */
    DECIMAL("DECIMAL", Types.DECIMAL, BigDecimal.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 65L,
     ...
     */
    TINYINT("TINYINT", Types.TINYINT, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 3L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * TINYINT[(M)] UNSIGNED [ZEROFILL]
     * 
     ...
     * 
     * BOOLEAN is converted to TINYINT(1) during DDL execution i.e. it has the same
     * precision=3. Thus we have to
     * look at full data type name and convert TINYINT to BOOLEAN (or BIT) if it has
     ...
     */
    SMALLINT("SMALLINT", Types.SMALLINT, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 5L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * SMALLINT[(M)] UNSIGNED [ZEROFILL]
     * 
     ...
     */
    INT("INT", Types.INTEGER, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 10L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * INT[(M)] UNSIGNED [ZEROFILL]
     * 
    ...
    INT_UNSIGNED("INT UNSIGNED", Types.INTEGER, Long.class,
            MysqlType.FIELD_FLAG_UNSIGNED | MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 10L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FLOAT[(M,D)] [UNSIGNED] [ZEROFILL]
     * A small (single-precision) floating-point number. Permissible values are
     * -3.402823466E+38 to -1.175494351E-38, 0,
     * and 1.175494351E-38 to 3.402823466E+38. These are the theoretical limits,
     * based on the IEEE standard. The actual
     ...
     * decimal point. If M and D are omitted,
     ...
     * A floating-point number. p represents the precision in bits, but MySQL uses
     * this value only to determine whether
     * to use FLOAT or DOUBLE for the resulting data type. If p is from 0 to 24, the
     * data type becomes FLOAT with no M or D values.
     * If p is from 25 to 53, the data type becomes DOUBLE with no M or D values.
     * The range of the resulting column is the same as
     * for the single-precision FLOAT or double-precision DOUBLE data types.
     */
    FLOAT("FLOAT", Types.REAL, Float.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 12L,
            "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FLOAT[(M,D)] UNSIGNED [ZEROFILL]
     * 
    ...
    FLOAT_UNSIGNED("FLOAT UNSIGNED", Types.REAL, Float.class,
            MysqlType.FIELD_FLAG_UNSIGNED | MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 12L,
            "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * DOUBLE[(M,D)] [UNSIGNED] [ZEROFILL]
     * A normal-size (double-precision) floating-point number. Permissible values
     * are -1.7976931348623157E+308 to
     * -2.2250738585072014E-308, 0, and 2.2250738585072014E-308 to
     * 1.7976931348623157E+308. These are the theoretical limits,
     ...
     * REAL[(M,D)] [UNSIGNED] [ZEROFILL]. Exception: If the REAL_AS_FLOAT SQL mode
     * is enabled, REAL is a synonym for FLOAT rather than DOUBLE.
     */
    DOUBLE("DOUBLE", Types.DOUBLE, Double.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 22L,
            "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * DOUBLE[(M,D)] UNSIGNED [ZEROFILL]
     * 
    ...
    DOUBLE_UNSIGNED("DOUBLE UNSIGNED", Types.DOUBLE, Double.class,
            MysqlType.FIELD_FLAG_UNSIGNED | MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 22L,
            "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FIELD_TYPE_NULL = 6
     */
     ...
     * from the epoch and the value 0 is reserved for representing '0000-00-00
     * 00:00:00', the "zero" TIMESTAMP value.
     * An optional fsp value in the range from 0 to 6 may be given to specify
     * fractional seconds precision. A value
     * of 0 signifies that there is no fractional part. If omitted, the default
     * precision is 0.
     * 
     * Protocol: FIELD_TYPE_TIMESTAMP = 7
     * 
     */
    // TODO If MySQL server run with the MAXDB SQL mode enabled, TIMESTAMP is
    // identical with DATETIME. If this mode is enabled at the time that a table is
    // created, TIMESTAMP columns are created as DATETIME columns.
    // As a result, such columns use DATETIME display format, have the same range of
    // values, and there is no automatic initialization or updating to the current
    // date and time
     ...
     */
    BIGINT("BIGINT", Types.BIGINT, Long.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 19L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BIGINT[(M)] UNSIGNED [ZEROFILL]
     * 
    ...
    BIGINT_UNSIGNED("BIGINT UNSIGNED", Types.BIGINT, BigInteger.class,
            MysqlType.FIELD_FLAG_UNSIGNED | MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 20L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    MEDIUMINT("MEDIUMINT", Types.INTEGER, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 7L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * MEDIUMINT[(M)] UNSIGNED [ZEROFILL]
     * 
     ...
     * but permits assignment of values to DATE columns using either strings or
     * numbers.
     * 
     ...
     * displays TIME values in
     * 'HH:MM:SS[.fraction]' format, but permits assignment of values to TIME
    ...
    /**
     * YEAR[(4)]
     * A year in four-digit format. MySQL displays YEAR values in YYYY format, but
     ...
     * all columns) and the character set used. For example, utf8 characters can
     * require up to three bytes per character,
     ...
     * The length prefix indicates the number
     * of bytes in the value. A VARCHAR column uses one length byte if values
     * require no more than 255 bytes, two length
     * bytes if values may require more than 255 bytes.
     * 
     * Note
     * MySQL 5.7 follows the standard SQL specification, and does not remove
     * trailing spaces from VARCHAR values.
     * 
     * VARCHAR is shorthand for CHARACTER VARYING. NATIONAL VARCHAR is the standard
     * SQL way to define that a VARCHAR
     ...
     */
    VARCHAR("VARCHAR", Types.VARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 65535L,
    ...
    /**
     * The size of JSON documents stored in JSON columns is limited to the value of
     * the max_allowed_packet system variable (max value 1073741824).
     ...
     * list of values 'value1',
     * 'value2', ..., NULL or the special '' error value. ENUM values are
     * represented internally as integers.
     * An ENUM column can have a maximum of 65,535 distinct elements. (The practical
     * limit is less than 3000.)
     ...
     * of values 'value1', 'value2', ... SET values are represented internally as
     * integers.
     * A SET column can have a maximum of 64 distinct members. A table can have no
     * more than 255 unique
     * element list definitions among its ENUM and SET columns considered as a group
     * 
     * Protocol: FIELD_TYPE_SET = 248
     */
    SET("SET", Types.CHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 64L,
            "('value1','value2',...) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * TINYBLOB
     ...
     * maximum length
     * is less if the value contains multibyte characters. Each TINYTEXT value is
     * stored using
     ...
     * is less if the value contains multibyte characters. Each MEDIUMTEXT value is
     * stored using a 3-byte
     * length prefix that indicates the number of bytes in the value.
     * 
     * Protocol: FIELD_TYPE_MEDIUM_BLOB = 250
     */
    MEDIUMTEXT("MEDIUMTEXT", Types.LONGVARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 16777215L,
            " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * LONGBLOB
     * A BLOB column with a maximum length of 4,294,967,295 or 4GB (232 - 1) bytes.
     * The effective maximum length
     * of LONGBLOB columns depends on the configured maximum packet size in the
     * client/server protocol and available
     ...
     * characters. The effective
     * maximum length is less if the value contains multibyte characters. The
     * effective maximum length
     * of LONGTEXT columns also depends on the configured maximum packet size in the
     * client/server protocol
     * and available memory. Each LONGTEXT value is stored using a 4-byte length
     * prefix that indicates
     * the number of bytes in the value.
     * 
     * Protocol: FIELD_TYPE_LONG_BLOB = 251
     */
    LONGTEXT("LONGTEXT", Types.LONGVARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 4294967295L,
            " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BLOB[(M)]
     ...
     * effective maximum length
     * is less if the value contains multibyte characters. Each TEXT value is stored
     ...
     * Protocol: FIELD_TYPE_BLOB = 252
     */
    TEXT("TEXT", Types.LONGVARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 65535L,
            "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * [NATIONAL] CHAR[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]
     * A fixed-length string that is always right-padded with spaces to the
     * specified length when stored.
     * M represents the column length in characters. The range of M is 0 to 255. If
     ...
     * NCHAR) is the standard SQL way
     * to define that a CHAR column should use some predefined character set. MySQL
     * 4.1 and up uses utf8
     * as this predefined character set.
     * 
     * MySQL permits you to create a column of type CHAR(0). This is useful
     * primarily when you have to be compliant
     * with old applications that depend on the existence of a column but that do
     * not actually use its value.
     * CHAR(0) is also quite nice when you need a column that can take only two
     * values: A column that is defined
     * as CHAR(0) NULL occupies only one bit and can take only the values NULL and
     * '' (the empty string).
     * 
     * Protocol: FIELD_TYPE_STRING = 254
     */
    CHAR("CHAR", Types.CHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 255L,
            "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BINARY(M)
     ...
     */
    GEOMETRY("GEOMETRY", Types.BINARY, null, 0, MysqlType.IS_NOT_DECIMAL, 65535L, ""), // TODO check precision, it isn't
                                                                                       // well documented, only
                                                                                       // mentioned that WKB format is
                                                                                       // represented by BLOB
    /**
    ...
    /**
     * Get MysqlType matching the full MySQL type name, for example "DECIMAL(5,3)
     * UNSIGNED ZEROFILL".
     * Distinct *_UNSIGNED type will be returned if "UNSIGNED" is present in
     * fullMysqlTypeName.
     * 
    ...
    public static MysqlType getByName(String fullMysqlTypeName) {
        ...
        // TODO parse complex names like [NATIONAL] VARCHAR(M) [CHARACTER SET
        ...
        // the order of checks is important because some short names could match parts
        // of longer names
        if (StringUtils.indexOfIgnoreCase(typeName, "DECIMAL") != -1
            ...
            // TODO Exception: If the REAL_AS_FLOAT SQL mode is enabled, REAL is a synonym
            // for FLOAT rather than DOUBLE.
            return StringUtils.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? DOUBLE_UNSIGNED : DOUBLE;
                                                                           ...
                                                                           * || StringUtils.indexOfIgnoreCase(name,
                                                                           * "FLOAT4") != -1 is caught by
                                                                           * "FLOAT" check
                                                                           */) {
            // TODO FLOAT(p) [UNSIGNED] [ZEROFILL]. If p is from 0 to 24, the data type
            // becomes FLOAT with no M or D values. If p is from 25 to 53, the data type
        ...
        } else if (StringUtils.indexOfIgnoreCase(typeName, "GEOM") != -1 // covers "GEOMETRY", "GEOMETRYCOLLECTION" and
                                                                         // "GEOMCOLLECTION"
    ...
    public static boolean supportsConvert(int fromType, int toType) {
        ...
        switch (fromType) {
            ...
            case java.sql.Types.TIME:
                ...
                /*
                 * Timestamp can be converted to char/binary types and date/time types (with
                 * loss of precision).
                 */
            case java.sql.Types.TIMESTAMP:
     ...
     *                      isDec
     * @param precision
     *                      represents the maximum column size that the server
     *                      supports for the given datatype.
     *                      <ul>
     *                      <li>For numeric data, this is the maximum precision.
     *                      <li>
     *                      For character data, this is the length in characters.
     *                      <li>For datetime datatypes, this is the length in
     *                      characters of the String
     *                      representation (assuming the maximum allowed precision
     ...
     *                      <li>Null is returned for data types where the column
     *                      size is not applicable.
     *                      </ul>
     * @param createParams
     *                      params
     */
    private MysqlType(String mysqlTypeName, int jdbcType, Class<?> javaClass, int allowedFlags, boolean isDec,
            Long precision, String createParams) {
